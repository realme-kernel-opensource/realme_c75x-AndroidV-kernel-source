...
UINT32 OV50D40_MIPI_RAW_ORIS_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC05A2_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 HI846_MIPI_RAW_ORIS_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/*Ark*/
UINT32 HI5022Q_MIPI_RAW23618_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC820CS_MIPI_RAW23618_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 PARKERA_QTECH_OV13B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_QTECH_IMX355_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_SHINETECH_GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_SHINETECH_OV02B1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_HOLITECH_GC02M1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_SHINETECH_OV02B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_HOLITECH_FRONT_S5K4H7_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_SHINETECH_FRONT_OV08D10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_QTECH_OV13B2A_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_SHINETECH_GC02M1B_50M_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERA_SHINETECH_OV02B1B_50M_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

/* Parker-B */
UINT32 PARKERB_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERB_SUNNY_S5K3P9SP_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERB_HLT_GC02M1_HLT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERB_SHINETECH_GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERB_SHINETECH_OV02B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 PARKERB_SHINETECH_OV02B1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
#endif //OPLUS_FEATURE_CAMERA_COMMON

#ifdef OPLUS_FEATURE_CAMERA_COMMON
UINT32 EVNE_QTECH_MAIN_S5KGM1ST03_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVEN_QTECH_MAIN_OV13B10_QTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVEN_HLT_FRONT_S5K4H7_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVEN_SHENGTAI_FRONT_OV8856_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVEN_HLT_DEPTH_GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVEN_SHENGTAI_MACRO_OV02B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVEN_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVENC_SHENGTAI_FRONT_OV8856_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 EVENC_SHINETECH_DEPTH_GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 ALADDIN_OV02B1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ALADDIN_OV08D10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

/*atom*/
UINT32 ATOM_OV50D40_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ATOM_OV02B1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ATOM_IMX355_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ATOM_S5K5E9YX04_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ATOM_22365_OV02B1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

/*miami*/
UINT32 MIAMI_OV64B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MIAMI_AAC2_OV64B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MIAMI_S5KJN1_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MIAMI_SC800CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 MIAMI_OV8856_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 SP2507_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 S5KHM6SX_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
UINT32 ZHAOYUN_QTECH_OV13B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUNLITE_QTECH_OV13B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUN_SHINETECH_GC02M1B_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUN_OPTICS_FRONT_GC5035_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUN_SHINETECH_GC02M1B_50M_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUN_SHINETECH_FRONT_OV08D10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUN_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUN_SHINETECH_MAIN_S5K3L6_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 ZHAOYUNLITE_OPTICS_MAIN_S5K3L6_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 LIMU_SHINETECH_IMX355_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 LIMU_QTECH_OV13B10_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 LIMU_OPTICS_FRONT_GC5035_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 LIMU_VGA_SP0A09_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 LIMU_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 LIMU_OPTICS_GC030A_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
#endif //OPLUS_FEATURE_CAMERA_COMMON
