...
/*ALADDIN*/
    ...
    {ALADDIN_OV50D40_SENSOR_ID,
    SENSOR_DRVNAME_ALADDIN_OV50D40,
    ALADDIN_OV50D40_MIPI_RAW_SensorInit},
#endif
#if defined(ALADDIN_OV08D10)
    {ALADDIN_OV08D10_SENSOR_ID,
    SENSOR_DRVNAME_ALADDIN_OV08D10,
    ALADDIN_OV08D10_MIPI_RAW_SensorInit},
#endif
#if defined(ALADDIN_OV02B1B)
    {ALADDIN_OV02B1B_SENSOR_ID,
    SENSOR_DRVNAME_ALADDIN_OV02B1B,
    ALADDIN_OV02B1B_MIPI_RAW_SensorInit},
#endif
/*ATOM*/
#if defined(ATOM_OV50D40)
    {ATOM_OV50D40_SENSOR_ID,
    SENSOR_DRVNAME_ATOM_OV50D40,
    ATOM_OV50D40_MIPI_RAW_SensorInit},
#endif
#if defined(ATOM_OV02B1B)
    {ATOM_OV02B1B_SENSOR_ID,
    SENSOR_DRVNAME_ATOM_OV02B1B,
    ATOM_OV02B1B_MIPI_RAW_SensorInit},
#endif
#if defined(ATOM_IMX355)
    {ATOM_IMX355_SENSOR_ID,
    SENSOR_DRVNAME_ATOM_IMX355,
    ATOM_IMX355_MIPI_RAW_SensorInit},
#endif
#if defined(ATOM_S5K5E9YX04)
    {ATOM_S5K5E9YX04_SENSOR_ID,
    SENSOR_DRVNAME_ATOM_S5K5E9YX04,
    ATOM_S5K5E9YX04_MIPI_RAW_SensorInit},
#endif
#if defined(ATOM_22365_OV02B1B)
    {ATOM_22365_OV02B1B_SENSOR_ID,
    SENSOR_DRVNAME_ATOM_22365_OV02B1B,
    ATOM_22365_OV02B1B_MIPI_RAW_SensorInit},
#endif
/*ORIS*/
...
/*PARKER*/
	...
	{PARKERA_QTECH_MAIN_OV13B10_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_QTECH_MAIN_OV13B10,
	PARKERA_QTECH_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_SHINETECH_MONO_GC02M1B)
	{PARKERA_SHINETECH_MONO_GC02M1B_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_SHINETECH_MONO_GC02M1B,
	PARKERA_SHINETECH_GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_SHINETECH_MONO_OV02B1B)
	{PARKERA_SHINETECH_MONO_OV02B1B_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_SHINETECH_MONO_OV02B1B,
	PARKERA_SHINETECH_OV02B1B_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_HOLITECH_MACRO_GC02M1)
	{PARKERA_HOLITECH_MACRO_GC02M1_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_HOLITECH_MACRO_GC02M1,
	PARKERA_HOLITECH_GC02M1_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_SHINETECH_MACRO_OV02B10)
	{PARKERA_SHINETECH_MACRO_OV02B10_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_SHINETECH_MACRO_OV02B10,
	PARKERA_SHINETECH_OV02B10_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_SHINETECH_MONO_GC02M1B_50M)
	{PARKERA_SHINETECH_MONO_GC02M1B_50M_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_SHINETECH_MONO_GC02M1B_50M,
	PARKERA_SHINETECH_GC02M1B_50M_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_SHINETECH_MONO_OV02B1B_50M)
	{PARKERA_SHINETECH_MONO_OV02B1B_50M_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_SHINETECH_MONO_OV02B1B_50M,
	PARKERA_SHINETECH_OV02B1B_50M_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_HOLITECH_FRONT_S5K4H7)
	{PARKERA_HOLITECH_FRONT_S5K4H7_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_HOLITECH_FRONT_S5K4H7,
	PARKERA_HOLITECH_FRONT_S5K4H7_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_SHINETECH_FRONT_OV08D10)
	{PARKERA_SHINETECH_FRONT_OV08D10_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_SHINETECH_FRONT_OV08D10,
	PARKERA_SHINETECH_FRONT_OV08D10_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_SHINETECH_MAIN_S5KJN103)
	{PARKERA_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_SHINETECH_MAIN_S5KJN103,
	PARKERA_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERA_QTECH_MAIN_OV13B2A) // a
	{PARKERA_QTECH_MAIN_OV13B2A_SENSOR_ID,
	SENSOR_DRVNAME_PARKERA_QTECH_MAIN_OV13B2A,
	PARKERA_QTECH_OV13B2A_MIPI_RAW_SensorInit},
#endif
/*Parker-B*/
#if defined(PARKERB_SHINETECH_MAIN_S5KJN103) // b
	{PARKERB_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
	SENSOR_DRVNAME_PARKERB_SHINETECH_MAIN_S5KJN103,
	PARKERB_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERB_SUNNY_FRONT_S5K3P9SP) // c
	{PARKERB_SUNNY_FRONT_S5K3P9SP_SENSOR_ID,
	SENSOR_DRVNAME_PARKERB_SUNNY_FRONT_S5K3P9SP,
	PARKERB_SUNNY_S5K3P9SP_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERB_SHINETECH_MONO_GC02M1B) // d
	{PARKERB_SHINETECH_MONO_GC02M1B_SENSOR_ID,
	SENSOR_DRVNAME_PARKERB_SHINETECH_MONO_GC02M1B,
	PARKERB_SHINETECH_GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERB_SHINETECH_MONO_OV02B1B)
	{PARKERB_SHINETECH_MONO_OV02B1B_SENSOR_ID,
	SENSOR_DRVNAME_PARKERB_SHINETECH_MONO_OV02B1B,
	PARKERB_SHINETECH_OV02B1B_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERB_HLT_MICRO_GC02M1)
	{PARKERB_HLT_MICRO_GC02M1_SENSOR_ID,
	SENSOR_DRVNAME_PARKERB_HLT_MICRO_GC02M1,
	PARKERB_HLT_GC02M1_HLT_MIPI_RAW_SensorInit},
#endif
#if defined(PARKERB_SHINETECH_MACRO_OV02B10)
	{PARKERB_SHINETECH_MACRO_OV02B10_SENSOR_ID,
	SENSOR_DRVNAME_PARKERB_SHINETECH_MACRO_OV02B10,
	PARKERB_SHINETECH_OV02B10_MIPI_RAW_SensorInit},
#endif
#if defined(LIMU_QTECH_MAIN_OV13B10)
    {LIMU_QTECH_MAIN_OV13B10_SENSOR_ID,
    SENSOR_DRVNAME_LIMU_QTECH_MAIN_OV13B10,
    LIMU_QTECH_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(LIMU_OPTICS_FRONT_GC5035)
    {LIMU_OPTICS_FRONT_GC5035_SENSOR_ID,
    SENSOR_DRVNAME_LIMU_OPTICS_FRONT_GC5035,
    LIMU_OPTICS_FRONT_GC5035_MIPI_RAW_SensorInit},
#endif
#if defined(LIMU_VGA_SP0A09)
    {LIMU_VGA_SP0A09_SENSOR_ID,
    SENSOR_DRVNAME_LIMU_VGA_SP0A09,
    LIMU_VGA_SP0A09_MIPI_RAW_SensorInit},
#endif
#if defined(LIMU_SHINETECH_MAIN_S5KJN103)
   {LIMU_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
    SENSOR_DRVNAME_LIMU_SHINETECH_MAIN_S5KJN103,
    LIMU_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit},
#endif
#if defined(LIMU_SHINETECH_MAIN_IMX355)
    {LIMU_SHINETECH_MAIN_IMX355_SENSOR_ID,
    SENSOR_DRVNAME_LIMU_SHINETECH_MAIN_IMX355,
    LIMU_SHINETECH_IMX355_MIPI_RAW_SensorInit},
#endif
#if defined(LIMU_OPTICS_VGA_GC030A)
    {LIMU_OPTICS_VGA_GC030A_SENSOR_ID,
    SENSOR_DRVNAME_LIMU_OPTICS_VGA_GC030A,
    LIMU_OPTICS_GC030A_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUN_QTECH_MAIN_OV13B10)
    {ZHAOYUN_QTECH_MAIN_OV13B10_SENSOR_ID,
    SENSOR_DRVNAME_ZHAOYUN_QTECH_MAIN_OV13B10,
    ZHAOYUN_QTECH_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUNLITE_QTECH_MAIN_S5K3L6)
	{ZHAOYUNLITE_QTECH_MAIN_S5K3L6_SENSOR_ID,
	SENSOR_DRVNAME_ZHAOYUNLITE_QTECH_MAIN_S5K3L6,
	ZHAOYUNLITE_OPTICS_MAIN_S5K3L6_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUNLITE_QTECH_MAIN_OV13B10)
    {ZHAOYUNLITE_QTECH_MAIN_OV13B10_SENSOR_ID,
    SENSOR_DRVNAME_ZHAOYUNLITE_QTECH_MAIN_OV13B10,
    ZHAOYUNLITE_QTECH_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUN_SHINETECH_MONO_GC02M1B)
    {ZHAOYUN_SHINETECH_MONO_GC02M1B_SENSOR_ID,
    SENSOR_DRVNAME_ZHAOYUN_SHINETECH_MONO_GC02M1B,
    ZHAOYUN_SHINETECH_GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUN_OPTICS_FRONT_GC5035)
    {ZHAOYUN_OPTICS_FRONT_GC5035_SENSOR_ID,
    SENSOR_DRVNAME_ZHAOYUN_OPTICS_FRONT_GC5035,
    ZHAOYUN_OPTICS_FRONT_GC5035_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUN_SHINETECH_MONO_GC02M1B_50M)
	{ZHAOYUN_SHINETECH_MONO_GC02M1B_50M_SENSOR_ID,
	SENSOR_DRVNAME_ZHAOYUN_SHINETECH_MONO_GC02M1B_50M,
	ZHAOYUN_SHINETECH_GC02M1B_50M_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUN_SHINETECH_FRONT_OV08D10)
	{ZHAOYUN_SHINETECH_FRONT_OV08D10_SENSOR_ID,
	SENSOR_DRVNAME_ZHAOYUN_SHINETECH_FRONT_OV08D10,
	ZHAOYUN_SHINETECH_FRONT_OV08D10_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUN_SHINETECH_MAIN_S5KJN103)
	{ZHAOYUN_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
	SENSOR_DRVNAME_ZHAOYUN_SHINETECH_MAIN_S5KJN103,
	ZHAOYUN_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit},
#endif
#if defined(ZHAOYUN_SHINETECH_MAIN_S5K3L6)
	{ZHAOYUN_SHINETECH_MAIN_S5K3L6_SENSOR_ID,
	SENSOR_DRVNAME_ZHAOYUN_SHINETECH_MAIN_S5K3L6,
	ZHAOYUN_SHINETECH_MAIN_S5K3L6_MIPI_RAW_SensorInit},
#endif
/*even evenb evenc*/
#if defined(EVEN_QTECH_MAIN_S5KGM1ST03)
	{EVEN_QTECH_MAIN_S5KGM1ST03_SENSOR_ID,
	SENSOR_DRVNAME_EVEN_QTECH_MAIN_S5KGM1ST03,
	EVNE_QTECH_MAIN_S5KGM1ST03_SensorInit},
#endif
#if defined(EVEN_QTECH_MAIN_OV13B10)
	{EVEN_QTECH_MAIN_OV13B10_SENSOR_ID,
	SENSOR_DRVNAME_EVEN_QTECH_MAIN_OV13B10,
	EVEN_QTECH_MAIN_OV13B10_QTECH_MIPI_RAW_SensorInit},
#endif
#if defined(EVEN_HLT_FRONT_S5K4H7)
	{EVEN_HLT_FRONT_S5K4H7_SENSOR_ID,
	SENSOR_DRVNAME_EVEN_HLT_FRONT_S5K4H7,
	EVEN_HLT_FRONT_S5K4H7_MIPI_RAW_SensorInit},
#endif
#if defined(EVEN_SHENGTAI_FRONT_OV8856)
	{EVEN_SHENGTAI_FRONT_OV8856_SENSOR_ID,
	SENSOR_DRVNAME_EVEN_SHENGTAI_FRONT_OV8856,
	EVEN_SHENGTAI_FRONT_OV8856_MIPI_RAW_SensorInit},
#endif
#if defined(EVEN_HLT_DEPTH_GC02M1B)
	{EVEN_HLT_DEPTH_GC02M1B_MIPI_SENSOR_ID,
	SENSOR_DRVNAME_EVEN_HLT_DEPTH_GC02M1B,
	EVEN_HLT_DEPTH_GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(EVEN_SHENGTAI_MACRO_OV02B10)
	{EVEN_SHENGTAI_MACRO_OV02B10_SENSOR_ID,
	SENSOR_DRVNAME_EVEN_SHENGTAI_MACRO_OV02B10,
	EVEN_SHENGTAI_MACRO_OV02B10_MIPI_RAW_SensorInit},
#endif
#if defined(EVEN_SHINETECH_MAIN_S5KJN103)
	{EVEN_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
	SENSOR_DRVNAME_EVEN_SHINETECH_MAIN_S5KJN103,
	EVEN_SHINETECH_MAIN_S5KJN103_MIPI_RAW_SensorInit},
#endif
#if defined(EVENC_SHENGTAI_FRONT_OV8856)
	{EVENC_SHENGTAI_FRONT_OV8856_SENSOR_ID,
	SENSOR_DRVNAME_EVENC_SHENGTAI_FRONT_OV8856,
	EVENC_SHENGTAI_FRONT_OV8856_MIPI_RAW_SensorInit},
#endif
#if defined(EVENC_SHINETECH_DEPTH_GC02M1B)
	{EVENC_SHINETECH_DEPTH_GC02M1B_SENSOR_ID,
	SENSOR_DRVNAME_EVENC_SHINETECH_DEPTH_GC02M1B,
	EVENC_SHINETECH_DEPTH_GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(EVENC_SHENGTAI_MACRO_OV02B10)
	{EVENC_SHENGTAI_MACRO_OV02B10_SENSOR_ID,
	SENSOR_DRVNAME_EVENC_SHENGTAI_MACRO_OV02B10,
	EVENC_SHENGTAI_MACRO_OV02B10_MIPI_RAW_SensorInit},
#endif
